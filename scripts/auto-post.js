// scripts/auto-post.js  (mukhlasin-diet-course repo)
...
// NOTE: IL Consulate removed — now handled by theinternationallover repo.
...
async function main() {
  ...
  const channels = [
    ...
    // IL Consulate removed — now handled by theinternationallover repo
  ];
