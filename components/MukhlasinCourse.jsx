...
const RESOURCE_MODULES = [
  {
    id: "how-to-begin",
    title: "How To Begin \u2014 The Correct Entry Point",
    intro: "There is only one correct starting point. Not because I say so \u2014 because the discipline itself demands it. A man who attempts to skip the first level has not understood what the first level is for. It is not a warm-up. It is the foundation. Without it, everything that follows is unstable.",
    sections: [
      { heading: "One Meal A Day \u2014 The Mandatory Entry Point", body: "Every practitioner begins at one meal a day. This is not optional. It is not a suggestion. It is the condition upon which the higher degrees become possible.\n\nThe stomach must be trained before the mind can be freed. The lower animal brain \u2014 which calls for food at all hours \u2014 must be brought under the command of the higher brain. This takes time. This takes repetition. This is what one meal a day accomplishes.\n\nDo not rush past this level. Most people never need to go beyond it. The health benefits alone \u2014 at this level, practiced correctly \u2014 are extraordinary." },
      { heading: "How Long At Each Level", body: "One meal a day should be practiced for months before any advancement is attempted. The body needs time to adjust. The mind needs time to learn what hunger actually is versus what the conditioned stomach is demanding.\n\nOne meal every two days comes after genuine mastery of level one. Not after a week. Not after a month of inconsistent practice. After real, sustained discipline at level one.\n\nOne meal every three days is advanced. The teacher himself took decades to arrive there. Any claim of arriving faster should be examined carefully." },
      { heading: "The Correct Time To Eat", body: "The meal should be taken in the late afternoon or evening \u2014 not in the morning. The body's digestive energy is lowest in the morning and highest in the evening. Eating with the body's natural rhythm produces better digestion, better rest, and better results.\n\nBreakfast \u2014 the breaking of a fast \u2014 was promoted by those who profit from your eating, not by those who understand your body. Question when you were taught this and by whom." },
      { heading: "What Breaks A Fast", body: "The stomach considers any nutrition a meal. Juice breaks the fast. Milk breaks the fast. A single piece of fruit breaks the fast.\n\nWater does not break the fast. Black coffee does not break the fast \u2014 and has documented benefits for the practitioner at this level.\n\nKnow the difference. The precision of the practice determines the precision of the results." },
    ],
  },
  {
    id: "the-foods",
    title: "The Prescribed Foods \u2014 What To Eat",
    intro: "The dietary laws given to us are not arbitrary restrictions. Each food was prescribed for a reason. The navy bean alone \u2014 understood correctly \u2014 is a complete nutritional system. What follows is the foundation of what to eat, how to prepare it, and why it was chosen for us.",
    sections: [
      { heading: "The Navy Bean \u2014 The Prescribed Staple", body: "The navy bean was prescribed as the staple food. Not as one option among many \u2014 as the foundation of the diet. It provides complete protein when combined with whole grains. It is a primary source of folate, iron, potassium, and magnesium.\n\nOne cup of cooked navy beans provides 63.7% of the recommended daily intake for folate. Elevated homocysteine \u2014 linked to heart disease \u2014 is directly addressed by folate consumption. The navy bean addresses this at the root.\n\nThe bean must be prepared correctly. Soak dry beans up to 30 hours at room temperature until they show signs of life \u2014 bubbles in the soak water indicate the enzymatic process has begun. This converts indigestible complex sugars into digestible form. Skipping this step causes gas. The preparation is part of the prescription." },
      { heading: "Milk \u2014 Raw and Whole", body: "Milk was prescribed as the first course of the meal. It should be taken before solid food, allowing the body to digest it separately before the heavier courses follow.\n\nRaw milk \u2014 unprocessed, from healthy animals \u2014 is the ideal. The Arabs, historically among the most physically distinguished people on earth, subsisted largely on milk and milk products with fruits, vegetables, and some meat.\n\nIf raw milk is not available, whole organic milk is the acceptable alternative. Begin the meal with milk. Allow it to move through the system before continuing." },
      { heading: "Fruits", body: "Fruit is not a snack. It is a course of the meal. Eat it as a complete course, not as a side addition to other foods.\n\nThe prescribed fruits include apples, oranges, bananas, pears, peaches, tangerines, mangos, plums, grapes (natural sun-dried, not processed), pomegranates, lemons, and grapefruit.\n\nFruit is healthiest eaten raw and uncooked. Its nutritional integrity is highest in its natural state. Learn to prepare fresh juices as an additional course \u2014 not as a replacement for solid food." },
      { heading: "Bread \u2014 Whole Wheat", body: "Bread made from whole wheat is part of the prescribed diet. Not the processed white bread that constitutes most commercial bread products \u2014 whole grain, minimally processed, correctly prepared.\n\nA people that can cultivate and produce their own bread from their own land has achieved a form of sovereignty. The dietary law points toward self-sufficiency, not dependence on commercial food systems that have been deliberately degraded." },
      { heading: "What To Avoid", body: "Field peas, black-eyed peas, speckled peas, red peas, brown peas, lima beans \u2014 these are not prescribed. Collard greens and turnip salad are not prescribed. Sweet potatoes and white potatoes are cheap, easily grown foods historically used to feed enslaved people \u2014 they were never intended as the dietary foundation of a rising people.\n\nAvoid processed foods. Avoid GMO-laden products. The nutrition has been deliberately removed from the commercial food supply. What fills the stomach does not necessarily nourish the body." },
    ],
  },
  {
    id: "higher-disciplines",
    title: "The Higher Disciplines \u2014 One Meal Every Two and Three Days",
    intro: "These levels are not for everyone, and they are not for right now if you have not yet mastered one meal a day. But they exist. They are real. And what they produce in the human body and mind has no equivalent in any pharmaceutical or medical intervention I have ever encountered. I bear witness to this from over thirty years of personal practice.",
    sections: [
      { heading: "One Meal Every Two Days \u2014 What Changes", body: "At one meal every two days, the need for sleep begins to diminish. Two to three hours of rest becomes sufficient where seven or eight were required before. This is not deprivation \u2014 it is the body operating at a higher efficiency because its energy is no longer consumed by constant digestion.\n\nThe ego begins to lose its grip. The lower persona \u2014 that reactive, fear-driven aspect of the self that is identified with the body's appetites \u2014 begins to quiet. What remains is clearer.\n\nPain from old injuries diminishes at this level in ways it did not at one meal a day. The body's healing energy, no longer divided, concentrates on repair." },
      { heading: "One Meal Every Three Days \u2014 What Becomes Possible", body: "At one meal every three days, time itself is experienced differently. The practitioner begins to see the mathematical structure of events \u2014 cause and effect become visible in real time in a way that is difficult to describe to someone who has not experienced it.\n\nThe body requires six hours to complete a meal at this level. The meal becomes a ceremony, not a convenience. Every element of it is intentional.\n\nThe elimination of waste at this level has been described by those who have reached it as a spiritual experience. The body, freed of toxins it has carried for years, begins to express its original design." },
      { heading: "The Monthly Three-Day Fast", body: "For those practicing one meal a day, a monthly three-day fast is recommended as a purification practice. The toxins that accumulate at this level require periodic intensive clearing.\n\nThose practicing one meal every two days or higher do not require the monthly fast in the same way \u2014 the constant purification of their discipline accomplishes what the monthly fast accomplishes for those at the lower level.\n\nThe three-day fast should be approached with preparation and should not be the first fast attempted. Build toward it." },
    ],
  },
  {
    id: "natural-beauty",
    title: "Natural Beauty \u2014 What The Discipline Produces In The Body",
    intro: "I wore facial hair for years to cover what I saw in the mirror. I knew there was a beautiful person beneath my exterior, but I had no knowledge of how to manifest those qualities. The discipline showed me what I had been looking for. What follows is not vanity \u2014 it is testimony.",
    sections: [
      { heading: "The Glow", body: "Those who practice this discipline correctly begin to produce a visible luminosity in the skin. It is not metaphorical. It is physical. The skin tightens. The blood circulates with ease. A cellular renewal occurs that modern medicine cannot duplicate.\n\nI have been described as appearing otherworldly in person at one meal every other day, while at one meal per day I appear closer to the level of everyone else. Others who observed this knew what they were witnessing was special before they knew how to explain it.\n\nThe envy it produced in some people was the first sign I had that something real was happening. Those who could not attain their own glow recognized it in someone else and responded accordingly." },
      { heading: "Reversing Apparent Age", body: "We begin to turn back the hands of time. A younger appearance and vitality that modern medicine cannot duplicate become the result of the discipline \u2014 not a claim about the discipline.\n\nThe skin is fed from within. The blood quality changes. The eyes become clearer. Features that had settled into a certain expression begin to open again.\n\nThis is not a cosmetic outcome. It is the body returning to its original state as the toxins that had been slowly accumulating over decades are expelled." },
      { heading: "The Atmosphere", body: "At higher levels of discipline, the practitioner develops what can only be described as a personal atmosphere \u2014 a field of energy that others enter when they come near.\n\nThis is documented in spiritual traditions across cultures. It is called different names in different systems. What it is, practically, is the body radiating the energy it is no longer spending on constant digestion and the management of toxins.\n\nThis atmosphere is felt before it is seen. People respond to it before they understand why." },
    ],
  },
  {
    id: "mental-spiritual",
    title: "Mental & Spiritual Effects \u2014 Clarity, Depression, Self-Talk",
    intro: "The connection between what we eat and how we think is not a metaphor. It is physiology. The mind is fed by the same blood that feeds the body. Purify the blood and the mind clarifies. Poison the blood and the mind follows. Thirty years of practice has shown me this with a precision that no argument can touch.",
    sections: [
      { heading: "Clarity", body: "At one meal every two days and beyond, the speed and accuracy of thinking increases in a measurable way. I am able to see the mathematics involved in events in real time. I see the reasoning behind my experiences and their possible outcomes and have the options in that time to decide which outcome would have the best lasting effects.\n\nTime has a new point of reference. One perceives time differently than one would at one meal a day, or with no discipline at all. This is not mysticism. It is the direct result of the brain receiving blood that is not burdened by the constant processing of food." },
      { heading: "Depression", body: "During times when I have been forced to revert to lower levels of discipline \u2014 for whatever reason \u2014 I have experienced depression. The depression lasted only as long as I remained in the state of low discipline, but vanished upon my return to my level of normalcy.\n\nThis is not a small observation. It means that the emotional state most people accept as a feature of their personality is, in many cases, a feature of their diet. The connection is direct and testable \u2014 by the individual, on themselves, through the practice." },
      { heading: "Self-Talk", body: "Having positive self-talk promotes healthy cellular regeneration. Whereas negative self-talk results in a degenerative condition that can negate even correct diet and exercise.\n\nThe water research of Masaru Emoto demonstrated that water exposed to loving words forms brilliant, complex crystalline patterns, while water exposed to negative thoughts forms incomplete, asymmetrical patterns with dull colors. The human body is approximately 60% water. The implications are not subtle.\n\nDemonstrate gratitude on a regular daily basis \u2014 not only to yourself during internal conversation, but to others, and for the food and drink that you intend to ingest. This is part of the practice, not an addition to it." },
      { heading: "Forgiveness and Healing", body: "Trauma stored in the body as energy \u2014 the energy of a car collision, a violent act, a sustained period of fear \u2014 must be released for healing to occur. This release requires forgiveness. Not forgiveness for the sake of the person who caused the injury. Forgiveness for the sake of the energy that is trapped in your body until you release it.\n\nIn order for there to be healing, this energy must be released. One must let go of it. One must forgive oneself for what was done to them. One must show gratitude to the Creator for the ability to understand and comprehend this truth.\n\nThis is not philosophical. It is physical. The trapped energy decays the tissue around it. Releasing it allows circulation to return and healing to begin." },
    ],
  },
  {
    id: "injury-healing",
    title: "Injury & Healing \u2014 What The Discipline Does For The Body",
    intro: "I have been hit by cars repeatedly. My spine was injured. I spent many tens of thousands of dollars on treatments that could not resolve the damage because I did not yet have the knowledge to reverse it. This section is what I wish I had known at the beginning. It is not theory. It is what I lived.",
    sections: [
      { heading: "How Injury Stores Energy", body: "When the body is injured, the energy of the impact is absorbed and retained in the body in the areas known as injuries. The energy of a speeding car slamming into a door is absorbed by the body and retained there \u2014 like a battery retaining a charge.\n\nThe body's attempt to isolate the area with inflammation also isolates it from circulation. When circulation is cut off, the tissue begins to decay. We experience this as chronic pain.\n\nFor healing to occur, this stored energy must be released. And the circulation must be restored to the injured area." },
      { heading: "What The Discipline Does", body: "Although I experienced traumatic injury to many areas of my body, the degree of pain that I felt at one meal a day was greatly diminished as I began to practice one meal every two days. As I practiced this discipline it was as though the burden was lifted from me.\n\nWhen forced to revert to one meal a day temporarily, I could feel the pains begin to return. This correlation \u2014 repeated over years \u2014 is not coincidence. The higher the discipline, the greater the healing energy available to the body.\n\nThe amount of energy required to heal an injured area is much greater than the amount of energy experienced during the injury. The discipline provides this energy by redirecting what was previously spent on digestion." },
      { heading: "When A Healer Is Needed", body: "There are times when the help of a healer is needed \u2014 when bodily tissue has become so damaged that the body's own efforts cannot cause movement in the area. In these cases, a healer can assist the circulation process with techniques that move the body's fluid and energy.\n\nChiropractic, massage therapy, acupuncture, and other forms of bodywork can assist. But they assist the body's own healing \u2014 they do not replace it. The discipline is the foundation. The healer is a tool.\n\nDo not confuse the tool with the foundation. I had great help at times from chiropractors and massage therapists. But even with this wonderful assistance, it was not a miracle cure by itself. The discipline was the miracle." },
    ],
  },
  {
    id: "exercise",
    title: "Exercise \u2014 The Correct Approach",
    intro: "Exercise is always about health and life, and it is never about one's vanities or ego. This distinction matters because the motivation determines the method. A man exercising for his ego will spend himself for the sake of performance. A man exercising for his health will monitor himself for the sake of longevity. One of these men will injure himself. The other will not.",
    sections: [
      { heading: "Exercise and The Discipline", body: "Those with heavy manual labor jobs will not be able to practice a discipline above one meal a day. The physical demands of the work will require the energy that the food provides. This is a practical reality, not a spiritual failing.\n\nFor those with light work, one meal every two or three days is possible without any hindrance. The body, freed from constant digestion, has substantial energy available for exercise and activity.\n\nMy workout informs my forthcoming meal of where the nutrients are most needed. I am ready to have a full and hearty meal following my workout. The meal becomes functional \u2014 targeted by the body's actual needs rather than the stomach's habituated demands." },
      { heading: "For Those With Injuries", body: "It is entirely possible to not only exercise but to reverse damage that one may presently call a permanent injury. While exercising, one must completely remove the ego from the performance of the exercise program and concentrate wholly upon the results of the regimen.\n\nAfter 30 years of practice, I began heavy yoga practice every morning and evening. Without a comprehensive understanding of my spine injuries, I was never able to find adequate care beyond chiropractic. Yoga allowed me to address the injuries from within \u2014 through range of motion, circulation, and the body's own healing intelligence.\n\nOne must learn to monitor exertion to benefit from exercise programs rather than simply spending oneself for the sake of vanity." },
      { heading: "The Animal Brain and Training", body: "The amygdala and hippocampus \u2014 the primary seat of our emotions \u2014 govern lower functions and can be trained to obey the higher brain function, much as one trains an animal. Wild animals are never tamed, but they can perform as the trainer desires through consistent reinforcement.\n\nThe lower animal brain that calls for food at all hours, that demands comfort and ease, that resists discipline \u2014 it can be trained. The method is constant reinforcement on a predetermined schedule. This is exactly what the dietary discipline provides: a schedule the lower brain eventually accepts as its reality." },
    ],
  },
  {
    id: "ramadan-fasting",
    title: "Ramadan & The National Fast \u2014 Context and Practice",
    intro: "The month of Ramadan is translated to mean the month of fire. That fire is the striving against the horizontal plain of one's own existence \u2014 to dwell upon the straight path, to burn away the impurities of one's personal carnal nature and live a truly upright existence. This is the inner meaning of the fast. The outer form without the inner meaning is only hunger.",
    sections: [
      { heading: "The Quran On Fasting", body: "The month of Ramadan is that in which the Quran was revealed \u2014 a guidance to men and clear proofs of the guidance and the Criterion. So whoever of you is present in the month, he shall fast therein, and whoever is sick or on a journey shall fast a like number of other days. God desires ease for you, and He desires not hardship for you.\n\nThis verse is the foundation. It prescribes Ramadan. It also prescribes flexibility for those who are sick or traveling. And it explicitly states that God desires ease \u2014 not suffering \u2014 for the practitioner." },
      { heading: "The Black Former Slave's Qualification", body: "The Black former slaves, lost in the Western hemisphere for over four hundred years, have been on a very long journey since being taken away from the world of Islam. No one can deny that this people has been made very sick by their experience.\n\nThere is no doubt that they qualify for the prescription: whoever is sick or on a journey shall fast a like number of other days. This people has been away from Islam for a very long time and is perfectly within right to fast a like number of other days \u2014 beyond the prescribed month, for the duration required to heal what has been done to them." },
      { heading: "The National Fast", body: "The National Fast \u2014 a three-day monthly fast \u2014 is repeatedly recommended for those who remain on the level of one meal a day. The toxins that accumulate at this level require periodic intensive clearing that the daily discipline alone does not provide.\n\nFor those practicing one meal every two or three days, the constant purification of their discipline accomplishes what the monthly fast accomplishes for those at the lower level. The higher discipline is itself a permanent fast." },
    ],
  },
  {
    id: "life-extension",
    title: "Life Extension \u2014 The Science and The Testimony",
    intro: "Li Qing Yuen was a tactical advisor from Sichuan, China. Records from 1827 show the Imperial Chinese government congratulating him on his 150th birthday. He lived, by the most conservative estimates, to 197 years old. By others, to 256. He attributed his longevity to performing his exercises every day \u2014 regularly, correctly, and with sincerity \u2014 for 120 years. What he practiced, we practice. What he achieved, we are pursuing.",
    sections: [
      { heading: "Caloric Restriction \u2014 The Scientific Record", body: "The life-extending effect of reduced calorie diets was reported in 1935. Since then, caloric restriction has been proven to extend the average and maximum lifespan for many species including yeasts, worms, mice, and rats.\n\nThe NIA study found that monkeys on a lower calorie diet did not live longer but had significantly less incidence of cancer, diabetes, cardiovascular disease, and brain atrophy. The quality of life was measurably superior even where longevity was similar.\n\nThe Freedom of Information Act documents show that the US Federal government studied these teachings \u2014 under their own name of caloric restriction \u2014 beginning decades ago. What was studied by the enemy as a tool of social engineering was practiced by the faithful as a tool of liberation." },
      { heading: "What The Masters Say", body: "It is said that those who practice this discipline live as long as they want to. When they have no more to accomplish in this life \u2014 knowing the future \u2014 they do not stay around to wait for it to occur. They begin changing their diet to one they know will cause illness, aging, and death in the body.\n\nThese men exist among us. We do not know of their presence, for they do not make their presence known. Their purpose is the fulfillment of prophecy \u2014 when the time comes for some part of prophecy to be fulfilled, one of these men will seek out, teach, and guide some man who was born for this purpose.\n\nThis is not mythology. It is the pattern of transmission that every legitimate discipline follows." },
      { heading: "In Ancient Kemet", body: "In Ancient Kemet \u2014 Egypt \u2014 it is written in the Ma'at that it takes 42 years for a man to become God. Most of the population burns their body out and begins winding down into their eternal graves long before this threshold.\n\nIt has been said that it takes 70 years to learn how to live. According to this philosophy, one who has just reached their sixth decade has only recently begun to understand the subject. Every year of correct practice is preparation for what comes next." },
    ],
  },
  {
    id: "medical-resources",
    title: "Medical Resources \u2014 When To Consult A Professional",
    intro: "This course is not medical advice. It is the testimony of one man's spiritual practice over more than thirty years. Before making any significant change to your diet \u2014 particularly if you have existing health conditions \u2014 consult a qualified medical professional. These resources are provided to support that consultation, not to replace it.",
    sections: [
      { heading: "When To Seek Medical Guidance", body: "Consult a physician before beginning any fasting practice if you have diabetes or blood sugar regulation issues, cardiovascular disease, kidney disease, a history of eating disorders, or any condition for which you are currently taking medication.\n\nExtended fasting affects blood sugar, blood pressure, electrolyte balance, and medication absorption. A physician who understands fasting can monitor these changes and advise accordingly. A physician who does not understand fasting may advise against it without adequate basis \u2014 in which case a second opinion from a physician who specializes in integrative or functional medicine is appropriate." },
      { heading: "Baseline Lab Recommendations", body: "Before beginning, consider establishing baseline laboratory values so you can track changes over time. Useful baselines include: complete blood count (CBC), comprehensive metabolic panel (CMP), fasting glucose and HbA1c, lipid panel, vitamin B12 and D levels, iron and ferritin, and C-reactive protein (inflammation marker).\n\nRetest at six months and annually. The changes in these values over time will document what the discipline is doing in your body with a precision that subjective experience alone cannot provide." },
      { heading: "Emergency Contacts", body: "If you experience severe dizziness, chest pain, irregular heartbeat, confusion, or loss of consciousness during a fasting practice \u2014 end the fast immediately and seek emergency medical care.\n\nUnited States emergency services: 911\nPoison Control: 1-800-222-1222\nCrisis Text Line: Text HOME to 741741\n\nThese symptoms are not normal fasting responses. They indicate that something requires immediate professional attention." },
      { heading: "Condition-Specific Guidance", body: "Diabetes: Fasting significantly affects blood glucose and insulin requirements. Any diabetic who wishes to practice this discipline must do so under close medical supervision with frequent glucose monitoring.\n\nCardiovascular conditions: Extended fasting can affect electrolyte balance, which affects heart rhythm. Medical clearance and monitoring are essential.\n\nEating disorder history: This discipline is not appropriate for anyone with a history of disordered eating. The line between fasting as a spiritual discipline and restriction as a pathology must be clear. If there is any doubt, consult a mental health professional specializing in eating disorders before proceeding.\n\nPregnancy and nursing: Do not fast during pregnancy or while nursing. The nutritional requirements of the child take precedence." },
      { heading: "Telehealth and Consultation Options", body: "If access to a physician is limited, telehealth services provide consultations with licensed medical professionals.\n\nIntegrative medicine practitioners who understand fasting and dietary discipline are preferable to those who do not. Search for physicians with training in integrative, functional, or lifestyle medicine.\n\nFor community consultation and questions about this specific discipline, the course platform provides direct access to the author. Use the consultation options available in the platform for personalized guidance rooted in the actual practice." },
    ],
  },
];
...
export default function MukhlasinCourse() {
  ...
  if (view === "resource" && activeResource) {
    ...
    const modIdx = RESOURCE_MODULES.findIndex(m => m.id === mod.id);
    return (
      <div style={{ minHeight: "100vh", background: C.dark, color: C.cream, fontFamily: "Georgia, serif" }}>
        <div style={{ background: "#0a0a0a", borderBottom: `1px solid ${C.border}`, padding: "1rem 1.5rem", display: "flex", alignItems: "center", gap: "1rem", flexWrap: "wrap" }}>
          <button onClick={() => { stopSpeech(); setView("library"); }} style={{ background: "none", border: `1px solid ${C.gold}`, color: C.gold, padding: "6px 14px", borderRadius: "20px", cursor: "pointer", fontSize: "13px" }}>← Library</button>
          <div style={{ flex: 1 }}>
        ...
        <div style={{ maxWidth: "720px", margin: "0 auto", padding: "3rem 1.5rem" }}>
          <div style={{ background: "#0f0d0a", border: `1px solid ${C.border}`, borderLeft: `3px solid ${C.gold}`, padding: "1.5rem", marginBottom: "2.5rem" }}>
          ...
          {mod.sections.map((s, i) => (
            <div key={i} style={{ marginBottom: "2.5rem" }}>
              ...
              {s.body.split("\n\n").map((para, j) => (
                <p key={j} style={{ fontSize: "clamp(13px,1.8vw,15px)", color: C.slate, lineHeight: 1.9, marginBottom: "1rem", fontFamily: "sans-serif" }}>{para}</p>
              ))}
            </div>
          ))}
